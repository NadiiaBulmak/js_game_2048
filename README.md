# 🎮 JS 2048 Game | [DEMO](https://nadiiabulmak.github.io//js_game_2048/)
...
- **Parcel** — development server and bundling
...
- **DOM Manipulation & Event Handling**: Dynamic UI updates and smooth keyboard/swipe interactions. 🖱️⌨️
- **Responsive Design**: Works on both desktop and mobile devices. 📱💻
- **Easy to Extend**: Clean code structure allows adding new features or customizations easily. ✨
...
```bash
git clone https://github.com/NadiiaBulmak/js_game_2048
```
